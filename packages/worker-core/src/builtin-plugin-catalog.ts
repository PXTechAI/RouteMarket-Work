...
const BROWSER_PLUGIN = {
  ...
  permissions: ["project.read", "browser.read", "browser.interact"],
  ...
  contributes: {
    ...
    tools: [
      ...
      tool("browser_screenshot", "Capture browser screenshot", "Capture the visible browser page.", "local.browser.screenshot", "R0"),
